    ...
    <div className="space-y-6 max-w-5xl mx-auto pb-12 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 w-full sm:w-auto">
          <button
            onClick={onOpenModal}
            className="flex-1 sm:flex-initial px-4 py-2 rounded-xl bg-[#161C27] hover:bg-[#1C2433] text-[#F8FAFC] text-xs font-semibold flex items-center justify-center gap-2 border border-[#222936] hover:border-[#303848] transition-all shadow-sm"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-initial px-4 py-2 rounded-xl bg-gradient-to-r from-[#8B5CF6] to-[#7C3AED] hover:from-[#7C3AED] hover:to-[#6D28D9] text-white text-xs font-bold flex items-center justify-center gap-2 shadow-lg shadow-[#8B5CF6]/20 transition-all hover:-translate-y-0.5"
          >
      ...
      <div className="p-4 sm:p-6 lg:p-8 rounded-2xl bg-[#121722] border border-[#222936] shadow-lg shadow-black/20 space-y-6 min-w-0">
        
        {/* Enterprise Identification Banner */}
        <div className="p-4 sm:p-6 rounded-xl bg-[#0F1219] border border-[#222936] flex flex-col md:flex-row items-start md:items-center justify-between gap-6 min-w-0">
          <div className="space-y-2 min-w-0">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-[#F8FAFC] truncate">{businessName}</h2>
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-[#A7B0C0]">
          ...
          <div className="p-4 rounded-xl bg-[#161C27] border border-[#303848] text-center w-full md:w-auto md:min-w-[150px] shadow-sm shrink-0">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-4 text-center">
          <div className="p-3 sm:p-4 rounded-xl bg-[#0F1219] border border-[#222936] space-y-1 min-w-0">
          ...
          <div className="p-3 sm:p-4 rounded-xl bg-[#0F1219] border border-[#222936] space-y-1 min-w-0">
            ...
            <div className="text-xl sm:text-2xl font-black text-[#10B981]">{healthScore}/100</div>
          ...
          <div className="p-3 sm:p-4 rounded-xl bg-[#0F1219] border border-[#222936] space-y-1 min-w-0">
            ...
            <div className="text-xl sm:text-2xl font-black text-[#F8FAFC] truncate">{turnoverFormatted || '—'}</div>
          ...
          <div className="p-3 sm:p-4 rounded-xl bg-[#0F1219] border border-[#222936] space-y-1 min-w-0">
            ...
            <div className="text-xl sm:text-2xl font-black text-[#38BDF8] truncate">{runwayMonths} M</div>
            <div className="text-[10px] text-[#38BDF8] font-semibold truncate">Reserve Depth</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="p-4 sm:p-5 rounded-xl bg-[#0F1219] border border-[#222936] space-y-3 min-w-0">
            <h4 className="text-xs font-bold text-[#F8FAFC] uppercase tracking-wider flex items-center gap-1.5">
              <FileCheck2 className="w-4 h-4 text-[#8B5CF6] shrink-0" /> Operational & Solvency Ratios
            </h4>
        ...
        <div className="pt-6 border-t border-[#222936] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#707A8C]">
            ...
            {onNavigate && (
              <>
                <button
                  ...
                  className="flex-1 sm:flex-initial px-3 py-1.5 rounded-lg bg-[#161C27] hover:bg-[#1C2433] text-[#F8FAFC] font-semibold flex items-center justify-center gap-1 border border-[#222936] transition-all shadow-sm"
                >
                ...
                <button
                  ...
                  className="flex-1 sm:flex-initial px-3 py-1.5 rounded-lg bg-[#161C27] hover:bg-[#1C2433] text-[#14B8A6] font-semibold flex items-center justify-center gap-1 border border-[#14B8A6]/30 transition-all"
                >
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 w-full sm:w-auto">
            <button
              onClick={onOpenModal}
              className="flex-1 sm:flex-initial px-3.5 py-2 rounded-lg bg-[#161C27] hover:bg-[#1C2433] text-[#F8FAFC] font-semibold border border-[#222936] transition-all shadow-sm text-center"
            >
              {t('passport.fullScreen', 'Full Screen View')}
            </button>
            <button
              onClick={handleDownload}
              className="flex-1 sm:flex-initial px-4 py-2 rounded-lg bg-gradient-to-r from-[#8B5CF6] to-[#7C3AED] hover:from-[#7C3AED] hover:to-[#6D28D9] text-white font-bold transition-all shadow-md shadow-[#8B5CF6]/20 text-center"
            >
              {t('common.printPdf', 'Print / Save PDF')}
            </button>
          </div>
