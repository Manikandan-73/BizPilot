    ...
    <div className="space-y-6 pb-12 max-w-5xl mx-auto font-sans">
        ...
        <div className="p-5 rounded-2xl bg-[#121722] border border-[#222936] shadow-lg shadow-black/20 space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#222936]">
            ...
            <div className="text-left sm:text-right">
              <span className="text-[10px] text-[#707A8C]">Subscription Expiry</span>
      ...
      <div className="p-6 rounded-2xl bg-[#121722] border border-[#222936] space-y-5 shadow-lg shadow-black/20">
        ...
        <div className="space-y-2.5 max-w-md">
          <label className="block text-xs font-bold text-[#A7B0C0]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`p-3.5 rounded-xl border text-left transition-all relative ${
                language === 'en'
                  ? 'border-[#8B5CF6] bg-[#8B5CF6]/15 text-[#F8FAFC] shadow-sm ring-1 ring-[#8B5CF6]/40'
                  : 'border-[#222936] bg-[#0F1219] text-[#A7B0C0] hover:border-[#303848] hover:text-[#F8FAFC]'
              }`}
            >
              <div className="flex items-center justify-between mb-1">
                <span className="text-base">🇬🇧</span>
                {language === 'en' && <Check className="w-4 h-4 text-[#8B5CF6]" />}
              </div>
              <div className="font-bold text-xs">{t('settings.english', 'English')}</div>
              <div className="text-[10px] text-[#707A8C] mt-0.5">MSME Financial Terminology</div>
            </button>
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <span className="text-base">🇮🇳</span>
                {language === 'ta' && <Check className="w-4 h-4 text-[#8B5CF6]" />}
              </div>
              <div className="font-bold text-xs">{t('settings.tamil', 'தமிழ் (Tamil)')}</div>
              <div className="text-[10px] text-[#707A8C] mt-0.5">இயற்கையான தமிழ் நிதிச் சொற்கள்</div>
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0D1118] border border-[#222936] rounded-xl px-3.5 py-2.5 text-[#F8FAFC] outline-none focus:border-[#8B5CF6] focus:bg-[#161C27] transition-all"
                required
              />
            </div>
            ...
            <div>
              ...
              >
                {BUSINESS_TYPES.map((t) => (
                  <option key={t} value={t} className="bg-[#121722] text-[#F8FAFC]">{t}</option>
                ))}
              </select>
            </div>
