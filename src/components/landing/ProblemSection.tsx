      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
            Why MSMEs Struggle to Access Funding
          </h2>
          <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
            While India powers one of the world's most vibrant economies, millions of viable small enterprises remain invisible to formal banking channels.
          </p>
        </div>

        {/* Big Counter Banner */}
        <div className="mb-14 p-8 rounded-2xl bg-gradient-to-r from-slate-900 via-purple-950/40 to-slate-900 border border-purple-500/30 text-center relative overflow-hidden shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {problems.map((p, idx) => {
            ...
            return (
              <div 
                key={idx}
                className="glass-panel p-6 rounded-2xl border border-slate-800/80 hover:border-purple-500/40 transition-all hover:translate-y-[-2px] group space-y-4 flex flex-col justify-between"
              >
